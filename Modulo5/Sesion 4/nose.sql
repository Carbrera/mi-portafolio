...
INSERT into herramienta VALUES(1,'Taladro Electrico',10000),(2,'Cierra Electrica',20000),(3,'Pistola de Clavos',30000),(4,'Lijadora',40000),(5,'Serrucho Electrico',50000);
...
DELETE FROM {tabla} WHERE {atributo_campo} = {valor};DELETE FROM cliente WHERE rut = '44444444-4';

-- 5. Elimina la primera herramienta
DELETE FROM herramienta WHERE id_herramienta = 1;

-- 6.- Inserte 2 arriendos para cada cliente
INSERT into arriendo (folio, fecha, dias, valor_dia, garantia, id_herramienta, rut_cliente) VALUES(1,'12/11/22',5,20000,'Eficacia en 5 dias o menos',2,'22222222-2'),(2,'12/11/22',2,30000,'Eficacia en 2 dias o menos',3,'22222222-2'),(3,'12/11/22',1,40000,'Eficacia en 1 dia',4,'33333333-3'),(4,'12/11/22',3,40000,'Eficacia en solo 3 dias',4,'33333333-3');
