...
CREATE TABLE arriendo(
    ...
    CONSTRAINT fk_arriendo_id_herramienta FOREIGN KEY (id_herramienta) REFERENCES herramienta(id_herramienta),
    CONSTRAINT fk_arriendo_rut_cliente FOREIGN KEY (rut_cliente) REFERENCES cliente(rut)
